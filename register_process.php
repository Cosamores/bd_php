...
/*     if (!preg_match('/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/', $password)) {
        $errors[] = 'Password should contain at least one uppercase letter, one lowercase letter, one digit, and one special character, and be at least 8 characters long!';
    } */
    ...
    // Hash the password
    $hashedPassword = password_hash($password, PASSWORD_DEFAULT);  /* password_hash($password, PASSWORD_DEFAULT); */
